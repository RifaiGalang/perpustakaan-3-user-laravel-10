        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="card-title">Nama Kategori</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                        ...
                                        {{-- <div class="modal fade" id="modalCreate" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog ">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="POST" action="/kategori/tambah"
                            ...
                            <form method="POST" action="/nama-kategori/update/{{ $d->id }}"
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $d->id_buku }}" class="form-control"
                                            name="nama_kategori" placeholder="Nama Kategori ..." required>
                                    </div>
                                    <div class="form-group">
                                        <label>Nama Kategori</label>
                                        <input type="text" value="{{ $d->id_kategori }}" class="form-control"
                                            name="nama_kategori" placeholder="Nama Kategori ..." required>
                                    </div>
                                    <div class="modal-footer">
